...
public class QajaCoursePage {
    ...
    public void assertUserGotIncorrectPhoneNumberNotification(String incorrectPhoneNumberNotification) {
        final String actualIncorrectPhoneNumberNotification = webDriver.findElement(By.className("js-rule-error-phone")).getText();
    ...
    public void assertUserGotTooShortPhoneNumberNotification(String tooShortPhoneNumberNotification) {
        final String actualTooShortPhoneNumberNotification = webDriver.findElement(By.className("js-rule-error-minlength")).getText();
